 ...
 */
final class Version20240325082227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE purchase_order (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, currency_id INT NOT NULL, coupon_id INT DEFAULT NULL, tax_number VARCHAR(255) DEFAULT NULL, price INT DEFAULT NULL, tax INT NOT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_21E210B24584665A (product_id), INDEX IDX_21E210B238248176 (currency_id), INDEX IDX_21E210B266C5951B (coupon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
